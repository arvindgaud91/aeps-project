                        ...
                        <div class="m-t-xs">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-7">
                                    ...
                                    <span data-toggle="counter" data-end="113" class="number"> @{{ deposit_amount_weekly || 0}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="m-t-xs">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-7">
                                    ...
                                    <!-- <h4 class="value"><span class="indicator indicator-equal mdi mdi-chevron-right"></span><span data-toggle="counter" data-end="113" class="number"><i class="fa fa-rupee"></i> @{{ deposit_amount_today || 0 }}</span> <i class="fa fa-level-up text-success"></i></h4> --><!--
                                    <h4><i class="fa fa-rupee"></i>
                                    <span data-toggle="counter" data-end="113" class="number"> @{{ deposit_amount_monthly || 0}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
