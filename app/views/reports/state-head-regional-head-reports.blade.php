    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="container">
          ...
          <div class="col-md-2">
              <button ng-click="exportFile('aeps-stateHeadSale', stateHeadSales)" class="btn btn-primary" style="float: right;">Export as excel</button>
          </div>
        </div>
         <ul class="nav nav-pills nav-justified">
              ...
              <div class="table-responsive">
                    ...
                    <tbody class="no-border-x">
                      ...
                      <td>@{{stateHeadSale.id}}</td>
                        <td><a href="/cluster-head-reports-for-state-head/@{{stateHeadSale.id}}">@{{stateHeadSale.name}}</a></td>
                        <td>@{{countOfClusterHead[stateHeadSale.id]}}</td>
                        <td>@{{sumOfAgentAmount[stateHeadSale.id]}}</td>
                      </tr>
                    </tbody>
                  </table>
                  </div>
