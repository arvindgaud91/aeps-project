    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="container">
          ...
          <div class="col-md-2">
              <button ng-click="exportFile('aeps-distributorSalesReportDateWise', distributorSales)" class="btn btn-primary" style="float: right;">Export as excel</button>
          </div>
        </div>
        <br/>
          @if( Auth::user()->isRegionalHead() )
              ...
              <div class="table-responsive">
                    ...
                    <tbody class="no-border-x">
                      <tr ng-repeat="distributorSale in distributorSales">
                        ...
                        <td><a href="/agent-distributor-date-report-for-area-sales-officer/@{{distributorSale.id}}">@{{distributorSale.name}}</a></td>
                        <td>@{{distributorAgentCount[distributorSale.id]}}</td>
                        <td>@{{distributorFTDSum[distributorSale.id]}}</td>
                        <td>@{{distributorLMTDSum[distributorSale.id]}}</td>
                        <td>@{{distributorMTDSum[distributorSale.id]}}</td>
                      </tr>
                    </tbody>
                  </table>
                  </div>
