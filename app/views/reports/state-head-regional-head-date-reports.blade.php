    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="container">
          ...
          <div class="col-md-2">
              <button ng-click="exportFile('aeps-stateHeadSalesDateReport', stateHeadSales)" class="btn btn-primary" style="float: right;">Export as excel</button>
          </div>
        </div>
        <br/>
         <ul class="nav nav-pills nav-justified">
              ...
              <div class="table-responsive">
                    ...
                    <tbody class="no-border-x">
                      <tr ng-repeat="stateHeadSale in stateHeadSales">
                        <td>@{{stateHeadSale.id}}</td>
                        <td><a href="/cluster-head-regional-head-date-report/@{{stateHeadSale.id}}">@{{stateHeadSale.name}}</a></td>
                        <td>@{{countOfClusterHead[stateHeadSale.id]}}</td>
                        <td>@{{stateHeadFTDSum[stateHeadSale.id]}}</td>
                        <td>@{{stateHeadLMTDSum[stateHeadSale.id]}}</td>
                        <td>@{{stateHeadMTDSum[stateHeadSale.id]}}</td>
                      </tr>
                    </tbody>
                  </table>
                  </div>
