    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="container">
          ...
          <div class="col-md-2">
              <button ng-click="exportFile('aeps-salesExecutiveSale', salesExecutiveSales)" class="btn btn-primary" style="float: right;">Export as excel</button>
          </div>
        </div>
         <ul class="nav nav-pills nav-justified">
              ...
              <div class="table-responsive">
                    ...
                    <tbody class="no-border-x">
                      ...
                      <td>@{{salesExecutiveSale.id}}</td>
                        <td><a href="/sales-executive-reports-for-area-sales-officer/@{{salesExecutiveSale.id}}">@{{salesExecutiveSale.name}}</a></td>
                        <!-- <td>@{{salesExecutiveSale.phone_no}}</td> -->
                        <td>@{{countOfDistributor[salesExecutiveSale.id]}}</td>
                        <td>@{{sumOfAgentAmount[salesExecutiveSale.id]}}</td>
                      </tr>
                    </tbody>
                  </table>
                  </div>
