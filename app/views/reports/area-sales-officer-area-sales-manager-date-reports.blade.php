    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="container">
          ...
          <div class="col-md-2">
              <button ng-click="exportFile('aeps-areaSalesOfficerSalesDateReport', areaSalesOfficerSales)" class="btn btn-primary" style="float: right;">Export as excel</button>
          </div>
        </div>
        <br/>
          @if( Auth::user()->isRegionalHead() )
          ...
          <ul class="nav nav-pills nav-justified">
            ...
            <li><a href="/area-sales-manager-reports-for-state-head">Area Sales Officer Sales Reports</a></li>
            <li class="active"><a>Area Sales Officer Sales Reports Date Wise</a></li>
          </ul>
          @endif
           @if( Auth::user()->isClusterHead() )
              ...
              <div class="table-responsive">
                    ...
                    <tbody class="no-border-x">
                      <tr ng-repeat="areaSalesOfficerSale in areaSalesOfficerSales">
                        ...
                        <td><a href="/sales-executive-date-reports-for-area-sales-manager/@{{areaSalesOfficerSale.id}}">@{{areaSalesOfficerSale.name}}</a></td>
                        <td>@{{countOfSalesExecutive[areaSalesOfficerSale.id]}}</td>
                        <td>@{{areaSalesOfficerFTDSum[areaSalesOfficerSale.id]}}</td>
                        <td>@{{areaSalesOfficerLMTDSum[areaSalesOfficerSale.id]}}</td>
                        <td>@{{areaSalesOfficerMTDSum[areaSalesOfficerSale.id]}}</td>
                      </tr> 
                    </tbody> 
                  </table>
                  </div>
