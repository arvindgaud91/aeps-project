...
@section('content')
<style type="text/css">a:hover{color: #34495e !important;}</style>
<div ng-controller="listTicketCtrl"  class="head-weight">
  <div class="row">
    <center><h1 style="margin-top:80px;color: #333;font-size: 3.25em;text-align: center;line-height: 110%;font-weight: bold; ">Please Wait For Redirect ..</h1>
    <a style="font-size: 24px;color: #337ab7;" href="http://support.digitalindiapayments.com/agent/view/ticket" id="myCheck" target="_blank">Please Click Here If Not Redirected..!</a></center>
  </div>
</div>
@stop
@section('javascript')
...
angular.module('DIPApp')
 ...
 var storage1 = new CrossStorageClient('http://aeps.digitalindiapayments.com/hub');
...
window.open('http://support.digitalindiapayments.com/agent/view/ticket');
}
